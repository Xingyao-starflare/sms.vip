    ...
    en: {
      ...
      pricing: {
        message: {
          ...
          unit: 'USD/SMS',
          countries: [
            { name: 'Philippines', code: 'PH', price: '0.006' },
            ...
            { name: 'Brazil', code: 'BR', price: '0.007' },
        ...
        voice: {
          ...
          countries: [
            ...
            { name: 'Pakistan', code: 'PK', price: '0.012' },
            { name: 'Brazil', code: 'BR', price: '0.0084' },
            { name: 'Mexico', code: 'MX', price: '0.0022' },
            { name: 'Vietnam', code: 'VN', price: '0.018' },
